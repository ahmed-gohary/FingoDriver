...
public class PaymentResponse
{
    ...
    public PaymentResponse(String transactionId, String gatewayTransactionId, String gatewayAuthCode, String maskedCardNumber, String merchantId, String timestamp) {
